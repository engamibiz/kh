...
class CreateSeoRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $array['page'] = ['nullable', Rule::in(['home','projects', 'properties','single_project','single_property','about','contact','careers','blogs','single_blog','unit_types','developers','single_developer','thank_you','terms','privacy','sell_unit'])];
