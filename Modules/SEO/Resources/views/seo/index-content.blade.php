        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('seo::seo.seo')}}</span>
                            <small>{{trans('seo::seo.list')}}</small>
                        </h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            --}}
                            @if (auth()->user()->hasPermission('create-seo'))
                                <a href="{{route('seo.create')}}" class="btn btn-primary btn-sm"  data-path="{{route('seo.modals.create')}}" data-title="{{trans('seo::seo.create_seo')}}" data-modal-load>
                                    <span>
                                        <i class="la la-plus"></i>
                                        <span>{{trans('seo::seo.create_seo')}}</span>
                                    </span>
                                </a>
                            @endif
                            {{--
                ...
                <div class="kt-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="seo_table">
                        <thead>
                            <tr>
                                <th>{{__('seo::seo.id')}}</th>
                                <th>{{__('seo::seo.seo')}}</th>
                                <th>{{__('seo::seo.page')}}</th>
                                <th>{{__('seo::seo.created_at')}}</th>
                                <th>{{__('seo::seo.last_updated_at')}}</th>
                                <th>{{__('seo::seo.actions')}}</th>
                            </tr>
                        </thead>
                    </table>
                    <!--end: Datatable -->
