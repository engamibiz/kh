...
namespace Modules\Inventory\Http\Requests\Positions;
...
class CreateIPositionRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        // $array['translations.*.position'] = "required|string|max:191|unique:i_position_trans,position,NULL,id";
        $array['translations.*.position'] = "required|string|max:191";
