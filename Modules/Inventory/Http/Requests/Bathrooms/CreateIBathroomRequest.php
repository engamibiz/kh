...
namespace Modules\Inventory\Http\Requests\Bathrooms;
...
class CreateIBathroomRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        // $array['translations.*.displayed_text'] = "required|string|max:191|unique:i_bathroom_trans,displayed_text,NULL,id";
