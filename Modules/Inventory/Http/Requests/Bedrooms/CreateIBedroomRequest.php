...
namespace Modules\Inventory\Http\Requests\Bedrooms;
...
class CreateIBedroomRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        // $array['translations.*.displayed_text'] = "required|string|max:191|unique:i_bedroom_trans,displayed_text,NULL,id";
