...
class UpdateIDesignTypeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        $array = array();
        $array['id'] = "required|exists:i_design_types,id,deleted_at,NULL";
        ...
        $array['translations.*.type'] = "required|string|max:191";
