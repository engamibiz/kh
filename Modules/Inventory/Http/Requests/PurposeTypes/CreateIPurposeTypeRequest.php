...
class CreateIPurposeTypeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        // $array['translations.*.purpose_types'] = "required|string|max:191|unique:i_purpose_types_trans,purpose_types,NULL,id";
