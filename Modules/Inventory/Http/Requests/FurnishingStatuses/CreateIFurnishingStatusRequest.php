...
class CreateIFurnishingStatusRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        // $array['translations.*.furnishing_status'] = "required|string|max:191|unique:i_furnishing_status_trans,furnishing_status,NULL,id";
        $array['translations.*.furnishing_status'] = "required|string|max:191";
