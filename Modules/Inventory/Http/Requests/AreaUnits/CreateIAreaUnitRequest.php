...
namespace Modules\Inventory\Http\Requests\AreaUnits;
...
class CreateIAreaUnitRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        // $array['translations.*.area_unit'] = "required|string|max:191|unique:i_area_unit_trans,area_unit,NULL,id";
        $array['translations.*.area_unit'] = "required|string|max:191";
