...
namespace Modules\Inventory\Http\Requests\PaymentMethods;
...
class CreateIPaymentMethodRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        // $array['translations.*.payment_method'] = "required|string|max:191|unique:i_payment_method_trans,payment_method,NULL,id";
        $array['translations.*.payment_method'] = "required|string|max:191";
