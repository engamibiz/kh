...
class UpdateIOfferingTypeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        $array = array();
        $array['id'] = "required|exists:i_offering_types,id,deleted_at,NULL";
        ...
        $array['translations.*.offering_type'] = "required|string|max:191";
