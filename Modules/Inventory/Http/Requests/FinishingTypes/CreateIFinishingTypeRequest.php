...
namespace Modules\Inventory\Http\Requests\FinishingTypes;
...
class CreateIFinishingTypeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        // $array['translations.*.finishing_type'] = "required|string|max:191|unique:i_finishing_type_trans,finishing_type,NULL,id";
        $array['translations.*.finishing_type'] = "required|string|max:191";
