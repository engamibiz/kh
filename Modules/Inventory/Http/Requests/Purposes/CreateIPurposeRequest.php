...
namespace Modules\Inventory\Http\Requests\Purposes;
...
class CreateIPurposeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        // $array['translations.*.purpose'] = "required|string|max:191|unique:i_purpose_trans,purpose,NULL,id";
        $array['translations.*.purpose'] = "required|string|max:191";
