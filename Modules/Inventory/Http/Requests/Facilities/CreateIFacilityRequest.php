...
namespace Modules\Inventory\Http\Requests\Facilities;
...
class CreateIFacilityRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        // $array['translations.*.facility'] = "required|string|max:191|unique:i_facility_trans,facility,NULL,id";
        $array['translations.*.facility'] = "required|string|max:191";
        $array['translations.*.description'] = "nullable|string|max:191";
