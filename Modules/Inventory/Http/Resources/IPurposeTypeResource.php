...
class IPurposeTypeResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'order' => $this->order,
            'svg' => $this->svg,
            'purpose_type' => $this->value,
            // 'purpose' => $this->purpose ? $this->purpose->value : null, // N+1 Problem
            // 'translations' => json_decode(json_encode(IPurposeTypeTranslationResource::collection($this->translations))),
