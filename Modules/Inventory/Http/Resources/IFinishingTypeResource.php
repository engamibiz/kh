...
class IFinishingTypeResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            'id' => $this->id,
            'order' => $this->order,
            'finishing_type' => $this->value,
            'color_class' => $this->color_class,
            // 'translations' => json_decode(json_encode(IFinishingTypeTranslationResource::collection($this->translations))),
