...
class IFloorNumberResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            'id' => $this->id,
            'order' => $this->order,
            'floor_number' => $this->value,
            'count' => $this->count,
            // 'translations' => json_decode(json_encode(IFloorNumberTranslationResource::collection($this->translations))),
