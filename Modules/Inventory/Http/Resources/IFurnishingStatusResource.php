...
class IFurnishingStatusResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            'id' => $this->id,
            'order' => $this->order,
            'furnishing_status' => $this->value,
            'color_class' => $this->color_class,
            // 'translations' => json_decode(json_encode(IFurnishingStatusTranslationResource::collection($this->translations))),
