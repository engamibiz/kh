...
class IAreaUnitResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            'id' => $this->id,
            'order' => $this->order,
            'area_unit' => $this->value,
            'color_class' => $this->color_class,
            // 'translations' => json_decode(json_encode(IAreaUnitTranslationResource::collection($this->translations))),
