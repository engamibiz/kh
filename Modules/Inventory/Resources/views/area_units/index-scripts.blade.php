                    ...
                    render: function(data, type, full, meta) {
                        ...
                        @if(auth()->user()->hasPermission('update-inventory-area-unit'))
                            value += `
                                    ...
                                    `;
                            value += `
                                        <a href="{{route('inventory.area_units.replicate')}}" class="dropdown-item" data-toggle="modal" data-target="#fast_modal" data-path="{{route('inventory.area_units.replicate')}}" data-title="{{trans('inventory::inventory.copy')}}" data-id="` + full.id + `" data-modal-load>
                                            <span>
                                                <i class="la la-edit"></i>
                                                <span>{{trans('inventory::inventory.copy')}}</span>
                                            </span>
                                        </a>
                                    `;
                        @endif
