...
@section('content')
<!--begin::Form-->
<form action="{{route('inventory.positions.store')}}" method="POST" id="create_position_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="createPositionCallback" data-parsley-validate>
    @csrf
...
<!-- Callback function -->
<script>
    function createPositionCallback() {
