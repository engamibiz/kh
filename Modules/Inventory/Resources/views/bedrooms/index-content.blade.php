        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('inventory::inventory.bedrooms')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            --}}
                            @if (auth()->user()->hasPermission('create-inventory-bedroom'))
                                <a href="{{route('inventory.bedrooms.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#fast_modal" data-path="{{route('inventory.bedrooms.modals.create')}}" data-title="{{trans('inventory::inventory.create_bedroom')}}" data-modal-load>
                                    <span>
                                        <i class="la la-plus"></i>
                                        <span>{{trans('inventory::inventory.create_bedroom')}}</span>
                                    </span>
                                </a>
                            @endif
                            {{--
                ...
                <div class="kt-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="bedrooms_table">
                        <thead>
                            <tr>
                                <th>{{__('inventory::inventory.id')}}</th>
                                <th>{{__('inventory::inventory.bedroom')}}</th>
