...
@section('content')
<!--begin::Form-->
<form action="{{route('inventory.sell_requests.store')}}" method="POST" id="create_sell_request_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="createSellRequestCallback" data-parsley-validate>
    @csrf
    ...
    <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
        <div class="m-form__actions m-form__actions--solid">
            <div class="row">
                <div class="col-lg-6">
                    <button type="submit" class="btn btn-success btn-brand">{{trans('inventory::inventory.create_sell_request')}}</button>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <!-- Callback function -->
    <script>
        function createSellRequestCallback() {
            // Reload datatable
