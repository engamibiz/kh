...
@section('content')
<!--begin::Form-->
<form action="{{route('inventory.design_types.store')}}" method="POST" id="create_design_type_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="createDesignTypeCallback" data-parsley-validate>
    @csrf
...
<!-- Callback function -->
<script>
    function createDesignTypeCallback() {
