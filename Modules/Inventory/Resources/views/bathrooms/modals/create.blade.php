...
@section('content')
    <!--begin::Form-->
    <form action="{{route('inventory.bathrooms.store')}}" method="POST" id="create_bathroom_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="createBathroomCallback" data-parsley-validate>
        @csrf
...
@push('scripts')
    <!-- Callback function -->
    <script>
        function createBathroomCallback() {
