...
@section('content')
<!--begin::Form-->
<form action="{{route('inventory.payment_methods.store')}}" method="POST" id="create_payment_method_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="createPaymentMethodCallback" data-parsley-validate>
    @csrf
...
<!-- Callback function -->
<script>
    function createPaymentMethodCallback() {
