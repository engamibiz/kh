...
@section('content')
<!--begin::Form-->
<form action="{{route('inventory.floor_numbers.store')}}" method="POST" id="create_floor_number_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="createFloorNumberCallback" data-parsley-validate>
    @csrf
        ...
        <div class="m-form__actions m-form__actions--solid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    {{--
                        <a href="{{route('inventory.floor_numbers.create')}}" data-8xload class="btn btn-brand btn-icon-sm">
...
<!-- Callback function -->
<script>
    function createFloorNumberCallback() {
