        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('inventory::inventory.floor_numbers')}}</span>
                            <small>{{trans('inventory::inventory.list')}}</small>
                        </h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <a href="{{route('home')}}" data-8xload class="btn btn-clean btn-icon-sm">
                            ...
                            --}}
                            @if (auth()->user()->hasPermission('create-inventory-floor-number'))
                                <a href="{{route('inventory.floor_numbers.create')}}" class="btn btn-focus m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air" data-toggle="modal" data-target="#fast_modal" data-path="{{route('inventory.floor_numbers.modals.create')}}" data-title="{{trans('inventory::inventory.create_floor_number')}}" data-modal-load>
                                    <span>
                                        <i class="la la-plus"></i>
                                        <span>{{trans('inventory::inventory.create_floor_number')}}</span>
                                    </span>
                                </a>
                            @endif
                            {{--
                ...
                <div class="kt-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="floor_numbers_table">
                        <thead>
                            <tr>
                                <th>{{__('inventory::inventory.id')}}</th>
                                <th>{{__('inventory::inventory.floor_number')}}</th>
                                <th>{{__('inventory::inventory.count')}}</th>
