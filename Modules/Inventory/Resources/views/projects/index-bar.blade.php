<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-subheader__main">
        <h4 class="kt-subheader__title" id="workspaceTitle"><i class="fas fa-building fa-sm"></i> {{__('inventory::inventory.projects')}}</h4>
    ...
    <div class="kt-subheader__toolbar">
        <div class="kt-subheader__wrapper">
            <a href="javascript:;" data-toggleit="#projectfilter" id="projectFilterBtn" class="btn kt-subheader__btn-secondary">
