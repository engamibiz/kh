...
@section('content')
    <!--begin::Form-->
    <form action="{{route('inventory.views.store')}}" method="POST" id="create_view_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="createViewCallback" data-parsley-validate>
        @csrf
            ...
            <div class="m-form__actions m-form__actions--solid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        {{--
                        <a href="{{route('inventory.views.create')}}" data-8xload class="btn btn-brand btn-icon-sm">
