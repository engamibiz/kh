...
@section('content')
<!--begin::Form-->
<form action="{{route('inventory.facilities.store')}}" method="POST" id="create_facility_form" enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="createFacilityCallback" data-parsley-validate>
    @csrf
...
<!-- Callback function -->
<script>
    function createFacilityCallback() {
