...
@section('content')
    <!--begin::Form-->
    <form action="{{route('inventory.publish_times.store')}}" method="POST" id="create_publish_time_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="createPublishTimeCallback" data-parsley-validate>
        @csrf
            ...
            <div class="m-form__actions m-form__actions--solid">
                <div class="row">
                    <div class="col-lg-12 text-right">
                        ...
                        {{--
                        <a href="{{route('inventory.publish_times.create')}}" data-8xload class="btn btn-sm btn-brand btn-icon-sm">
...
@push('scripts')
    <!-- Callback function -->
    <script>
        function createPublishTimeCallback() {
            // Reload datatable
