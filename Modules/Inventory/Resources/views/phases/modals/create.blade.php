...
<!--begin::Form-->
<form action="{{route('inventory.phases.store')}}" method="POST" id="create_phase_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="createphaseCallback" data-parsley-validate>
    @csrf
        ...
        <div class="form-group row">
            <div class="col-12 repeater">
                <div class="row col-6  form-group">
                    ...
                    <input name="delivery_date" autocomplete="off" class="form-control datetimepicker-init" placeholder="{{trans('inventory::inventory.delivery_date')}}" required data-parsley-required data-parsley-required-message="{{__('inventory::inventory.from_date_is_required')}}" data-parsley-trigger="change focusout" />
                </div>
        ...
        <div class="m-form__actions m-form__actions--solid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    {{--
                        <a href="{{route('inventory.phases.create')}}" data-8xload class="btn btn-brand btn-icon-sm">
