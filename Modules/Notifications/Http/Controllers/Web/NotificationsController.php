...
namespace Modules\Notifications\Http\Controllers\Web;
...
class NotificationsController extends Controller
{
    ...
    public function markAsRead(Request $request, $id)
    {
        ...
        event(new NotificationRead(request()->getHttpHost(), $request->user()->id, $id));
    }
    ...
    public function dismiss(Request $request, $id)
    {
        ...
        event(new NotificationRead(request()->getHttpHost(), $subscription->user->id, $id));
    }
}
