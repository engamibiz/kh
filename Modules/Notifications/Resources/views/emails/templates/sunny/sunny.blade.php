<html>
	<head>
		...
		<style type="text/css">{{ URL::asset('8x/assets/mail/css/sunny.css') }}</style>
		@if(isset($css))
		<style type="text/css">
			{{ $css }}
		</style>
								...
								<tr>
									...
									<td valign="top">
										<table align="right">
											...
											<tr>
												@if (isset($twitter))
													<td><a href="https://twitter.com/{{ $twitter }}"><img src="{{ URL::asset('8x/assets/mail/images/ark/fb.png') }}" alt="Twitter" height="25" width="25" style="border:0" /></a></td>
												@endif

												@if (isset($facebook))
													<td><a href="https://facebook.com/{{ $facebook }}"><img src="{{ URL::asset('8x/assets/mail/images/ark/fb.png') }}" alt="Facebook" height="25" width="25" style="border:0" /></a></td>
												@endif
											</tr>
										</table>
									</td>
