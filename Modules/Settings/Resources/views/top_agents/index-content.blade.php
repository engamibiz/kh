                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('settings::settings.top_agents')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            @if (auth()->user()->hasPermission('create-settings-teem'))
                                <a href="{{route('settings.top_agents.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#fast_modal" data-path="{{route('settings.top_agents.modals.create')}}" data-title="{{trans('settings::settings.create_top_agents')}}" data-modal-load>
                                    <span>
