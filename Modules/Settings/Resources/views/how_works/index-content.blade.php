                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('settings::settings.how_works')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            {{--
                            <!-- Full creation form -->
                            <a href="{{route('settings.how_works.create')}}" data-8xload class="btn btn-brand btn-icon-sm">
                            <i class="flaticon2-plus"></i> {{trans('settings::settings.create_new')}}
                            </a>
                            --}}
                            @if (auth()->user()->hasPermission('create-settings-how-work'))
                            <a href="{{route('settings.how_works.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#fast_modal" data-path="{{route('settings.how_works.modals.create')}}" data-title="{{trans('settings::settings.create_how_works')}}" data-modal-load>
                                <span>
