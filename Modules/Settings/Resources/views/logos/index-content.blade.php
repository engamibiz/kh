                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('settings::settings.logos')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            {{--
                            <!-- Full creation form -->
                            <a href="{{route('settings.logos.create')}}" data-8xload class="btn btn-brand btn-icon-sm">
                            <i class="flaticon2-plus"></i> {{trans('settings::settings.create_new')}}
                            </a>
                            --}}
                            @if (auth()->user()->hasPermission('create-settings-logo'))
                            <a href="{{route('settings.logos.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#fast_modal" data-path="{{route('settings.logos.modals.create')}}" data-title="{{trans('settings::settings.create_logos')}}" data-modal-load>
                                <span>
