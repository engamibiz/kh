            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        value += `
                                    <a href="{{route('settings.contacts.modals.update')}}" class="dropdown-item" data-toggle="modal" data-target="#fast_modal" data-path="{{route('settings.contacts.modals.update')}}" data-title="{{trans('settings::settings.update_contact')}}" data-id="` + full.id + `" data-modal-load>
                                        <span>
                        ...
                        value += `
                                    <a class="dropdown-item" data-8x-delete-it='{"container":false, "path":"` + delete_url + `", "callback": "deleteContactCallback"}' href="#"><i class="la la-trash"></i> {{__('settings::settings.delete_contact')}}</a>
                                `;
                        @endif
                        value += `
                                </div>
