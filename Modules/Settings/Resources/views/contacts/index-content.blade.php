                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('settings::settings.contacts')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            <a href="{{route('settings.contacts.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#fast_modal" data-path="{{route('settings.contacts.modals.create')}}" data-title="{{trans('settings::settings.create_contacts')}}" data-modal-load>
                                <span>
