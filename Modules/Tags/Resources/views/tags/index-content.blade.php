        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <span class="kt-portlet__head-icon">
                            <i class="kt-font-success fa fa-tags"></i>
                        </span>
                        <h3 class="kt-portlet__head-title">
                            <span class="kt-font-success" data-8xloadtitle>{{trans('tags::tags.tags')}}</span>
                            <small>{{trans('tags::tags.list')}}</small>
                        </h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            @haspermission('create-tag')
                                <a href="{{route('tags.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#fast_modal" data-path="{{route('tags.modals.create')}}" data-title="{{trans('tags::tags.create_tag')}}" data-modal-load>
                                    <span>
                                        <i class="la la-plus"></i>
                                        <span>{{trans('tags::tags.create_tag')}}</span>
                                    </span>
                                </a>
                            @endhaspermission
                            {{--
                ...
                <div class="kt-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="tags_table">
                        <thead>
                            <tr>
                                <th>{{__('tags::tags.id')}}</th>
                                <th>{{__('tags::tags.tag')}}</th>
                                <th>{{__('tags::tags.created_at')}}</th>
                                <th>{{__('tags::tags.last_updated_at')}}</th>
                                <th>{{__('tags::tags.actions')}}</th>
                            </tr>
                        </thead>
                    </table>
                    <!--end: Datatable -->
