                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('cms::cms.privacies')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            @if (auth()->user()->hasPermission('create-privacy'))
                                <a href="{{route('privacies.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#fast_modal" data-path="{{route('privacies.modals.create')}}" data-title="{{trans('cms::cms.create_privacy')}}" data-modal-load>
                                    <span>
