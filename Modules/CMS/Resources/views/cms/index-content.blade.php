                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('cms::cms.terms')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            @if (auth()->user()->hasPermission('create-terms-condition'))
                                <a href="{{route('terms.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#fast_modal" data-path="{{route('terms.modals.create')}}" data-title="{{trans('cms::cms.create_term')}}" data-modal-load>
                                    <span>
