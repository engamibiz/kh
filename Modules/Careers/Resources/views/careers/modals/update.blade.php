                ...
                <div data-repeater-list="translations">
                    ...
                    <div data-repeater-item class="row">
                        ...
                        <div class="col-6 mt-2">
                            ...
                            <input name="meta_title" data-parsley-maxlength="60" id="meta_title" type="text" class="form-control" value="" placeholder="{{__('careers::career.meta_title')}}" data-parsley-trigger="change focusout" data-parsley-maxlength="150" data-parsley-maxlength-message="{{__('careers::career.title_max_is_150_characters_long')}}">
                        </div>
                        <div class="col-lg-6 mt-2">
                            <label for="meta_description">{{__('careers::career.meta_description')}} <small class="text-muted"> - {{__('careers::career.optional')}}</small></label>
