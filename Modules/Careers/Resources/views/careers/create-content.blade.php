<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title" data-8xloadtitle>{{__('careers::career.create_career')}}</h3>
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="{{route('careers.index')}}" data-8xload class="kt-subheader__breadcrumbs-link">{{__('careers::career.careers')}}</a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                @else
                                        ...
                                        <div data-repeater-list="translations">
                                            <div data-repeater-item class="row">
                                                ...
                                                <div class="col-6 mt-2">
                                                    ...
                                                    <input name="meta_title" data-parsley-maxlength="60" id="meta_title" type="text" class="form-control" placeholder="{{__('careers::career.meta_title')}}" data-parsley-trigger="change focusout" data-parsley-maxlength="150" data-parsley-maxlength-message="{{__('careers::career.title_max_is_150_characters_long')}}">
                                                </div>
                                ...
                                <div class="m-form__actions m-form__actions--solid">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            {{--
                                <a href="{{route('careers.create')}}" data-8xload class="btn btn-brand btn-icon-sm">
