        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('locations::location.locations')}}</span>
                            <small>{{trans('locations::location.list')}}</small>
                        </h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            @if (auth()->user()->hasPermission('create-location'))
                            <a href="{{route('locations.modals.create',['id'=>request()->route('id')])}}" class="btn btn-primary btn-sm creatingbutton">
                                <span>
                                    <i class="la la-plus"></i>
                                    <span>{{trans('locations::location.create_location')}}</span>
                                </span>
                            </a>
                            @endif
                            {{--
                ...
                <div class="kt-portlet__body">
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="locations_table">
                        <thead>
                            <tr>
                                <th>{{__('locations::location.id')}}</th>
                                <th>{{__('locations::location.location')}}</th>
                                <th>{{__('locations::location.created_at')}}</th>
                                <th>{{__('locations::location.last_updated_at')}}</th>
                                <th>{{__('locations::location.actions')}}</th>
                            </tr>
                        </thead>
                    </table>
                    <!--end: Datatable -->
