...
namespace Modules\Testimonials\Http\Middleware;
...
class HasTestimonialsModule
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $hosts = Cache::rememberForever('has_testimonials_module', function () {
            $careers_module = DB::connection('mysql')->table('modules')->where('name', 'Testimonials Module')->first();
