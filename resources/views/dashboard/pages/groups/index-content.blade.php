                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('groups.groups')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            <a href="{{route('groups.create')}}" class="btn btn-brand btn-sm" data-toggle="modal" data-target="#fast_modal" data-path="{{route('groups.modals.create')}}" data-title="{{trans('groups.create_group_form')}}" data-modal-load>
                                <span>
