        ...
        <div class="row m-0">
            ...
            <div class="col-xl-4 p-0 mb-1 mb-xl-0">
                <div class="form-group search__input mb-1">
                    <input type="text" name="location" placeholder="{{__('locations::location.locations')}}" class="form-control" id="location_buy_form">
        ...
        <div class="advanced-search-area">
            <div class="row mt-xl-1 mx-0">
                ...
                <div class="col-xl-6 p-0">
                    <div class="form-group search__input mb-1">
                        <select class="form-control" id="must-have-buy" name="must_have[]" multiple>
                ...
                <div class="col-xl-6 p-0">
                    <div class="form-group search__input mb-1">
                        <select class="form-control" id="dont-have-buy" name="not_have[]" multiple>
                            @foreach($facilities as $facility)
                                <option value="{{$facility->id}}">{{$facility->facility}}</option>
                            @endforeach
                            @foreach($amenities as $amenity)
                ...
                <div class="col-md-3 p-0">
                    <div class="form-group search__input mb-1">
                        <select class="form-control" id="select-type-buy" name="offering_types[]" multiple>
                ...
                <div class="col-md-3 p-0">
                    <div class="form-group search__input mb-1">
                        <select class="form-control" id="payment_method_buy" name="payment_methods[]" multiple>
                ...
                <div class="col-xl-2 mb-1 col-sm-6 p-0">
                    <div class="form-group m-0">
                        <select class='dropdown-select show-tick Property-sell-select form-control' name="purpose_ids[]" multiple onchange="getPurposePurposeTypes($(this).val(), 'i_purpose_type_id_buy')" title="{{__('inventory::inventory.select_purpose')}}"  data-parsley-errors-container="#purpose_error_container">
                ...
                <div class="col-xl-2 mb-1 col-sm-6 p-0">
                    <div class="form-group m-0">
                        <select class='dropdown-select show-tick prop-type-select form-control' id="i_purpose_type_id_buy" name="purpose_type_ids[]" multiple title="{{__('inventory::inventory.purpose_type')}}">
                        </select>
                    </div>
                </div> <!-- ./ col-xl-2 -->
