<footer class="main-footer padding-block">
    <div class="container-fluid">
        ...
        <div class="logo-text mb-5">
            <img class="footer-logo" src="{{ asset('front/images/footer-logo.png') }}">
        </div>

        @include('front.partials.home.discover')
        <nav class="contacts__social">
            @foreach ($socials as $social)
                <a class="contacts__social--link 
            @if (strpos($social->icon, 'facebook')) 
                facebook
        ...
        <div class="copyrights text-center mt-5">
            <p>
                &copy; {{ __('main.all_rights_reserved') }}
